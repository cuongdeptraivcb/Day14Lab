...
namespace Day14Lab.Controllers
{
    public class LearnersController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? mid)
        {
            ...
            {
                var learners = _context.Learners.Where(l => l.MajorID == mid).ToList();
                return View(learners);
            }
        ...
        {
            var learners = _context.Learners.Where(l=> l.MajorID == mid).Include(l => l.Major).ToList();
